    ...
    <section className="relative overflow-hidden bg-gradient-to-b from-slate-50 to-white py-16">
      <div className="container grid gap-10 lg:grid-cols-2 lg:items-center">
        <div className="space-y-6">
          ...
          >
            {["Education-first expertise", "Managed hosting & monitoring", "Security-first architecture", "Analytics & reporting"].map(
              (item) => (
        ...
        >
          <div className="relative overflow-hidden rounded-3xl bg-primary shadow-soft">
            <Image src={heroImage} alt="Cloud infrastructure" width={1200} height={800} className="h-full w-full object-cover opacity-90" />
